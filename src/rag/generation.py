...
def generate(state: Dict[str, Any], llm, prompt_unused=None) -> Dict[str, str]:
    try:
        ...
        system_template = """You are a RAG assistant that answers questions based on the provided context and conversation history.
...
CRITICAL RULES:
1. Answer ONLY using information from the context above or previous history
